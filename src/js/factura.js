const logoEmpresa = `../asset/img/logocentral.jpg`;
...
function descargarFactura() {
  ...
  // --- ENCABEZADO ---
  doc.setFillColor(255, 255, 255); // Rojo Central Madeirense
  doc.rect(0, 0, 210, 30, "F");

  doc.addImage(logoEmpresa, "JPG", 15, 5, 40, 20);

  doc.setTextColor(0, 0, 0);
  doc.setFontSize(22);
  doc.setFont("helvetica", "bold");
  doc.text("CENTRAL MADEIRENSE, C.A.", 50, 16);
